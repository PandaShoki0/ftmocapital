  ...
  >
    ...
    <div class="flex items-center justify-center space-x-3">
      ...
      <a
        ...
        aria-label="X"
      >
      <svg fill="#9ca3af" width="25" height="25" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 1668.56 1221.19" viewBox="0 0 1668.56 1221.19" id="twitter-x">
      ...
      <a
        ...
        target="_blank"
        class="text-gray-500 hover:text-pink-500 dark:text-gray-400 dark:hover:text-pink-400"
      ...
      <!-- YouTube -->
      <a
        href="https://youtube.com/@altcryptogems?si=Ur-L-huPwUZ1v5_s"
        target="_blank"
      ...
      <a
        ...
        target="_blank"
        class="text-gray-500 hover:text-purple-600 dark:text-gray-400 dark:hover:text-purple-500"
        aria-label="Discord"
      >
...
<script>
  ...
  export default {
    ...
    setup() {
      ...
      const siteName = ref('Altcryptogems');
