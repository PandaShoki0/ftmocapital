<template>
  <div style="font-family: BinancePlex, Arial, sans-serif !important;">
    <div class="containered" style="margin: -18px -20px 3px -20px;">
      ...
      <Trades
        :key="
          $route.params.symbol + $route.params.currency + runningBots.length
        "
          ...
          >
            <form id="Order" @submit.prevent="Order()">
              <div class="grid grid-cols-2 gap-5">
                ...
                >
                  {{
                    active_bot.length != 0 ? active_bot.title : $t("Select Bot")
                  }}
                </Button>
                <select
                  id="durations"
                ...
                >
                  ...
                  <template
                    v-for="(timing, index) in active_bot.timing"
                    :key="index"
                  >
                ...
                <div class="">
                  ...
                  <div class="flex">
                    <input
                      ...
                      :disabled="active_bot.length == 0"
                      :class="{
                        'opacity-50': active_bot.length == 0,
                      }"
                      type="number"
                      ...
                      :min="active_bot ? active_bot.min_amount : 0.00001"
                      :max="active_bot ? active_bot.max_amount : 100000"
                      :step="active_bot ? active_bot.min_amount : 0.00001"
                      required=""
                      placeholder="Amount"
                ...
                <div class="">
                  ...
                  >
                    <a class="text-light">{{ $t("Wallet") }}</a>
                  </label>
                  <div class="flex">
                    <div v-if="balance !== null" class="input-group">
                      <input
                        :key="balance"
                        type="number"
                        :value="balance"
          ...
          >
            ...
            <div class="w-full">
              ...
              <div class="row">
                ...
                <div>
                  {{ $t("Highest APR Today") }}:
                  <span class="text-success">{{ bot.perc }}%</span>
                </div>
              </div>
            </div>
          </div>
    ...
    methods: {
      ...
      Order() {
        ...
        const time = this.active_bot.timing.find(
          (timing) => timing.id === Number(this.$refs.active_duration.value)
        );
