...
const Trade = () => import("@/main/Trade.vue");
const Plan = () => import("@/main/Plan.vue");

const routes = [
    { path: "/", component: Dashboard, meta: { title: "Dashboard" } },
    { path: "/dashboard", component: Dashboard, meta: { title: "Dashboard" } },
    { path: "/trade/demo", component: Trade, meta: { title: "Trade" } },
    { path: "/trade/live", component: Trade, meta: { title: "Trade" } },
    { path: "/plan", component: Plan, meta: { title: "Plan" } },
