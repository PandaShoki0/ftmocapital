<aside id="sidebar" class="hidden fixed left-0 z-20 flex-col flex-shrink-0 lg:w-[4rem] lg:flex duration-300"
    ...
    <div
        ...
        <div id="sidebarOverflow" class="flex flex-1 flex-col overflow-x-hidden" style="max-height: calc(88vh);  padding-top: 1.25rem; padding-bottom: 1rem"
            :class="!sidebarCollapsed ||
                (sidebarCollapsed && sidebarHover) ||
                sidebarMobile ?
                'overflow-y-auto' :
                'overflow-y-hidden'">
            <div class="flex-1 space-y-1 divide-y divide-gray-200 dark:divide-gray-700" style="padding-left: 0.75rem;
    padding-right: 0.75rem;">
                <ul class="space-y-2" id="sidebar-ul" style="padding-bottom: 0.5rem; padding-left:0;"
                    :class="{
                        expandedMenu:
                            !sidebarCollapsed ||
                            (sidebarCollapsed && sidebarHover) ||
