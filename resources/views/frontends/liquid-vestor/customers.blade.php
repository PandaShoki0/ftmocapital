                ...
                <div class="uk-width-3-4@m">
                    <div data-uk-grid>
                        <div class="uk-width-1-2@s uk-width-2-3@m">
                            <h2 class="uk-margin-remove">We <span class="in-highlight">help</span> our customers.</h2>
                            <p class="uk-text-lead uk-text-muted uk-margin-remove">To engage investors so their companies can grow</p>
                                ...
                                <li>
                                    <div class="uk-flex uk-flex-middle">
                                      <div class="in-icon-wrap circle primary-color uk-margin-right">
                                        ...
                                        <div>
                                            <h3 class="uk-margin-remove-bottom count" data-counter-end="35817">35817</h3>
                                            <span class="uk-label uk-label-success uk-text-small uk-border-pill">Business launch</span>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="uk-flex uk-flex-middle">
                                      <div class="in-icon-wrap circle primary-color uk-margin-right">
                                        ...
                                        <div>
                                            <h3 class="uk-margin-remove-bottom count" data-counter-end="4400">4400</h3>
                                            <span class="uk-label uk-label-success uk-text-small uk-border-pill">Investor engaged</span>
                                        </div>
                                    </div>
                                </li>
                            </ul>
            ...
            <div class="uk-grid uk-child-width-1-2@m in-testimonial-8" data-uk-grid>
                <div>
                    <div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                        <img class="uk-position-bottom-right" src="{{ asset('assets/frontends/liquid') }}/img/blockit/in-testimoni-2.png" alt="client-testimoni" width="200">
                        ...
                        <div class="uk-card-footer">
                            <img src="{{ asset('assets/frontends/liquid') }}/img/blockit/in-client-testi-1.svg" alt="client-logo" width="54">
                            <blockquote>
                ...
                <div>
                    <div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                        <img class="uk-position-bottom-right" src="{{ asset('assets/frontends/liquid') }}/img/blockit/in-testimoni-3.png" alt="client-testimoni" width="200">
                        <div class="uk-card-header">
                            <blockquote>
                        ...
                        <div class="uk-card-footer">
                            <img src="{{ asset('assets/frontends/liquid') }}/img/blockit/in-client-testi-2.svg" alt="client-logo" width="54">
                            <blockquote>
        ...
        <div class="uk-container">
            <div class="uk-grid uk-child-width-1-3@m in-testimonial-7" data-uk-grid>
                <div>
                    <div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                        <div class="uk-card-header">
                            <img src="{{ asset('assets/frontends/liquid') }}/img/blockit/in-client-testi-3.svg" alt="client-logo" width="60">
                        </div>
                ...
                <div>
                    <div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                        <div class="uk-card-header">
                            <img src="{{ asset('assets/frontends/liquid') }}/img/blockit/in-client-testi-4.svg" alt="client-logo" width="60">
                        </div>
                        <div class="uk-card-body">
                            <blockquote>
                ...
                <div>
                    <div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                        <div class="uk-card-header">
                            <img src="{{ asset('assets/frontends/liquid') }}/img/blockit/in-client-testi-5.svg" alt="client-logo" width="60">
                        </div>
                        <div class="uk-card-body">
                            <blockquote>
