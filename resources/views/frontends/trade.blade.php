...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ getImage(imagePath()['logoIcon']['path'] . '/favicon.ico') }}">
...
<body>
    <nav class="header-navbar navbar navbar-expand-lg items-center {{ $configData['navbarClass'] }} navbar-light navbar-shadow {{ $configData['navbarColor'] }}
 {{ $configData['layoutWidth'] === 'boxed' && $configData['verticalMenuNavbarType'] === 'navbar-floating' ? 'container-xxl' : '' }}"
        ...
        <div class="navbar-container flex content justify-between items-center">
    ...
    <div class="container-fluid">
        <div class="row match-height">
            <div class="col-12 lg:col-span-3 bordered darked px-0 tabbable">
                                        ...
                                        @foreach ($pair as $market)
                                            <tr>
                                                <td class="text-nowrap">
                                                    <a href="#"><i
                                                            class=" mr-1 text-warning icon-unlock bi bi-star"></i></a>
            ...
            <div class="col-12 lg:col-span-6 bordered darked px-0">
                <div class="flex d-lg-none justify-between items-center text-2">
                ...
                <div class="d-none d-lg-flex items-center p-1 text-2">
                                ...
                                <div class="row pb-1 px-1">
                                    <div class="col-6">
                                        <form class="text-center mt-1" id="marketFormBuy">
                                            <label for="basic-url"
                                                class="form-label mb-1 flex justify-between text-1 text-dark">
                                                <span>Amount</span>
                                                <span>
                                    ...
                                    <div class="col-6">
                                        <form class="text-center mt-1" id="limitFormBuy">
                                            ...
                                            <div class="input-group input-group-sm mb-1">
                                                ...
                                                <span
                                                    class="input-group-text text-dark border-0">{{ $currency }}</span>
                                                <span class="input-group-text text-dark border-0 ml-1">
            ...
            <div class="col-12 lg:col-span-3 bordered darked px-0">
