        ...
        <div class="grid grid-cols-2 gap-5 py-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col">
                        <label for="icon" class="input-group-text">{{ __('Select Icon') }}</label>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="md:col-span-6 mb-1">
                        <div class="img-fluid"
                            style="height:26px;width:26px;background-size: cover;background-image: url({{ getImage(imagePath()['logoIcon']['path'] . '/favicon.ico', '?' . time()) }})">
                        </div>
                    </div>
                    <div class="col">
