    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('admin.users.plan.update')}}" name="editForm">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" value="{{$plan->title}}" class="form-control input-lg"
                                            name="title">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="description">
                                    ...
                                    <div class="col-md-12 text-right margin-top-10" style="margin-top: 10px;">
                            ...
                            <div class="col-md-3">
                                    <h6>Trade Limit</h6>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-lg"  name="trade_limit" value="{{ $plan->trade_limit }}">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        Per Day
                                                    </span>
                            ...
                            <div class="col-md-3">                                    
                                <h6>ICON</h6>
                                <div class="input-group">
                                    <input type="text" value="{{ $plan->icon }}" class="form-control input-lg"
                                            name="icon">
                                    <div class="input-group-append"><span class="input-group-text">
                                            {!! $plan->icon !!}
                                            </span>
