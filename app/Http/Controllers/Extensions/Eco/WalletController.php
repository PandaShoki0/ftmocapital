...
class WalletController extends Controller
{
    ...
    public function transferFunds(Request $request)
    {
        $request->validate([
            ...
            'target_wallet' => 'required|in:trading,funding,future',
        ...
        }else if($target_wallet_provider == 'future'){
            $walletController = new FuturesWalletController();
            $to = FutureWallets::where('user_id', $user->id)->where('symbol', $request->currency)->where('provider', $walletController->provider)->first();
        }else {
        ...
        $transfer->trx = (isset($result['success']) && $result['success'] != false) ? $result->getReference() : getTrx();
        $transfer->txHash = (isset($result['success']) && $result['success'] != false) ? $result->getReference() : getTrx();
        $transfer->save();
        $transfer->clearCache();
        ...
        if($target_wallet_provider == 'future'){
