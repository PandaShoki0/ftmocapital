...
if (!isset($plat->system->maintenance) || $plat->system->maintenance != 1) {
    if (!isset($plat->frontend->frontend_status) || $plat->frontend->frontend_status != 1) {
        ...
        Route::get('/', action: [HomeController::class, 'newhome'])->name('home');
...
Route::get('how_it_works', [HomeController::class, 'how_it_works'])->name('frontend.pages.how_it_Works');
Route::get('faqs', [HomeController::class, 'faqs'])->name('frontend.pages.faqs');
...
// Route::view('about', 'frontends.liquid-vestor.about_pro')->name('about');
